...
public class MemoryDataAnalyzer {
    ...
    public static KPAreaData AnalyzeData(int dataFrame, int actualFrame) {
        KPAreaData memoryData = KProfilerHelper.ExtractAreaData(dataFrame, ProfilerArea.Memory);
        return memoryData;
    }
#if UNITY_2020_2_OR_NEWER
    public static KPAreaData AnalyzeData(int dataFrame, int actualFrame, RawFrameDataView rawFrameDataView)
    {
        KPAreaData memoryData = KProfilerHelper.ExtractAreaData(dataFrame, ProfilerArea.Memory, rawFrameDataView);
        return memoryData;
    }
#endif
}
